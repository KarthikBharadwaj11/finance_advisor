...
3. Conversations history table: Table consists of ID, User ID, session ID, role, content, tool name, tool call ID, tokens used and created at fields.
...
4. Portfolio table: The portfolio table consists of Portfolio ID, user iD, name, total value and currency. 
5. Portfolio allocations table: This table consists of portfolio ID, assest class, percentage and current value.
