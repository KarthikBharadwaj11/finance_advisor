...
The agent loop checks finish_reason on every LLM reponse. If its "tool_calls", execute the tool and continue the looping. If its "Stop", the LLM has produced its final answer and the loop exits. 
